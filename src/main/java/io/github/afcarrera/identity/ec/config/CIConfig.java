 ...
 * <p>This class initializes and links various handlers to form a chain for validating
 * identity documents based on configured properties.</p>
 */
public final class CIConfig {
     ...
     * <p>Retrieves configuration properties</p>
     * <p>Initialize the first element in the chain with various handlers</p>
     */
    private CIConfig() {
        CIPropertiesConfig ciPropertiesConfig = CIPropertiesConfig.getInstance();
        firstChainElement = IdentityConfigUtil.linkChain(
                new RegexHandler(ciPropertiesConfig.getRegexp()),
                List.of(new ProvinceCodeHandler(
                        ...
                        new FirstComparisonHandler(Integer.parseInt(ciPropertiesConfig.getFirstComparisonValue())),
                        new SecondComparisonHandler(Integer.parseInt(ciPropertiesConfig.getSecondComparisonMinuend()))
                )
        );
    }
