 ...
 *
 * <p>This class extends {@link AbstractIdentityHandler} and calculates the sum of the elements in
 * the multiplication list, then sets this sum as the last check digit in the context.
 */
public class ListSumHandler extends AbstractIdentityHandler {
   ...
   *
   * <p>The sum is then set as the last check digit in the context.
   *
  ...
  private Integer getSum(List<Integer> multiplicationList) {
    return multiplicationList.stream().reduce(0, Integer::sum);
  }
}
