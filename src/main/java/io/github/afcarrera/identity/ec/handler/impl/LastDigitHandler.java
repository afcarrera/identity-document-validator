 ...
 * <p>This class extends {@link AbstractIdentityHandler} and extracts the digit at the specified index
 * in the identity document's value, then sets this digit as the last digit in the context.</p>
 */
public class LastDigitHandler extends AbstractIdentityHandler {
     ...
     * <p>The extracted digit is then set as the last digit in the context.</p>
