 ...
 * <p>This class extends {@link AbstractIdentityHandler} and compares the result of subtracting
 * the last check digit from a specified minuend with the last digit. If they do not match,
...
public class SecondComparisonHandler extends AbstractIdentityHandler {
     ...
     * <p>Compares the result of subtracting the last check digit from the minuend with the last digit.</p>
     * @param context The identity document to be processed.
     * @throws IdentityDocumentException If the result of the subtraction does not match the last digit.
     */
    @Override
